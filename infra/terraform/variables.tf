...
variable "shopify_webhook_secret" { type = string, sensitive = true }
variable "tiendanube_webhook_secret" { type = string, sensitive = true }

variable "qstash_token" { type = string, sensitive = true }
variable "qstash_current_signing_key" { type = string, sensitive = true }
variable "qstash_next_signing_key" { type = string, sensitive = true }
variable "qstash_url" { type = string }
